defmodule WebAccWeb.CustomerControllerTest do
  use WebAccWeb.ConnCase

  alias WebAcc.Settings

  @create_attrs %{address: "some address", email: "some email", name: "some name", organization: "some organization", phone: "some phone", terms: "some terms"}
  ...
  def fixture(:customer) do
    {:ok, customer} = Settings.create_customer(@create_attrs)
    customer
  end
