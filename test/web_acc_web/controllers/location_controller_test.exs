defmodule WebAccWeb.LocationControllerTest do
  use WebAccWeb.ConnCase

  alias WebAcc.Settings

  @create_attrs %{address: "some address", contact: "some contact", lat: 120.5, long: 120.5, name: "some name"}
  ...
  def fixture(:location) do
    {:ok, location} = Settings.create_location(@create_attrs)
    location
  end
