defmodule WebAccWeb.ProductControllerTest do
  use WebAccWeb.ConnCase

  alias WebAcc.Settings

  @create_attrs %{image_url: "some image_url", long_desc: "some long_desc", name: "some name", retail_price: 120.5, short_desc: "some short_desc", sku: "some sku"}
  ...
  def fixture(:product) do
    {:ok, product} = Settings.create_product(@create_attrs)
    product
  end
