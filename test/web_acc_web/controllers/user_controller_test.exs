defmodule WebAccWeb.UserControllerTest do
  use WebAccWeb.ConnCase

  alias WebAcc.Settings

  @create_attrs %{crypted_password: "some crypted_password", name: "some name", password: "some password", role: "some role", role_id: 42, username: "some username"}
